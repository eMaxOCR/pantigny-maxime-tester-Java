...
public class DBConstants {
    ...
    public static final String GET_NUMBER_VEHICLE_REG = "SELECT COUNT(*) FROM ticket WHERE VEHICLE_REG_NUMBER = ?";
    public static final String GET_NUMBER_VEHICLE_REG_ALREADY_PARK = "SELECT COUNT(*) FROM ticket WHERE VEHICLE_REG_NUMBER = ? and OUT_TIME IS NULL";
}
