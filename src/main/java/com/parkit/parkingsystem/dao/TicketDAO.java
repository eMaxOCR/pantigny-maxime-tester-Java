...
public class TicketDAO {
    ...
    public Integer getNbTicket(String vehicleRegNumber) { //Count the amount of same REG number on tickets to verify if user use to come frequently.
    	Connection con = null;
    	int nbSameReg = 0;
        try {
        	con = dataBaseConfig.getConnection(); //Set connection to the database
            PreparedStatement ps = con.prepareStatement(DBConstants.GET_NUMBER_VEHICLE_REG); //Count how many they are same reg number.
